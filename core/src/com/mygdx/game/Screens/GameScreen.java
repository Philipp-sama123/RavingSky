...
public class GameScreen implements Screen {
    private MyGdxGame ravingSkyGame;
    ...
    public GameScreen(MyGdxGame ravingSkyGame) {
        gravity = 5f;
    ...
    public void render(float delta) {
        ...
        if (gameState == 0) {
            ...
            for (int i = 0; i < mushroomXs.size(); i++) {
                ...
                mushroomXs.set(i, mushroomXs.get(i) - MyGdxGame.MUSHROOM_VELOCITY_IN_PX);
            ...
            if (Gdx.input.justTouched()) {
                velocity = -MyGdxGame.PLAYER_JUMP_HEIGHT;
            }
            if (pause < 2) {
                pause++;
            } else {
...
//improve!!
    ...
    private void spawnMushroom() {
        if (mushroomCount < MyGdxGame.MUSHROOM_SPAWN_FREQUENCY) {
            mushroomCount++;
        } else {
            mushroomCount = 0;
            makeMushroom();
